# Generated by Django 2.1.1 on 2018-10-22 02:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('stripe_token', models.CharField(blank=True, editable=False, max_length=128)),
                ('purchased', models.CharField(choices=[('sku_DoNhM1EGgKGLeg', '1 Post'), ('sku_DoNp2frdbkieqn', '12 Posts'), ('plan_DoNu8JmqFRMrze', 'Unlimited Posts')], editable=False, max_length=30)),
                ('created_date', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
